...
\begin{lemma}\label{th:hatsinhat}
    ...
    \begin{itemize}
        \item A right $(a_1,a_1-f_1 \min\{\frac{a_1}{f_1}, \frac{a_2}{f_2}\})$-hat with a right-angle of $\alpha$ and
        \item a right $(a_2,a_2 - f_2 \min\{\frac{a_1}{f_1}, \frac{a_2}{f_2}\})$-hat with a left-angle of $\beta$.
    \end{itemize}
\end{lemma}
...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \item[(2)]
            ...
            By \Cref{th:split-property}, the hat is rounded by $y = a_i - f_i\frac{1-a_i}{1-f_i} = \frac{a_i(1-f_i)-f_i(1-a_i)}{1-f_i} = \frac{a_i-f_i}{1-f_i}$.
...
\begin{lemma}\label{th:roundedhatsinhat}
    ...
    For each $a_1 + a_2 \le a$, the following two shapes can be packed into the hat:
    \begin{itemize}
        \item A right $(a_1,\max\{b,a_1-f_1 \min\{\frac{a_1}{f_1}}, \frac{a_2}{f_2}\}\})$-hat with a right-angle of $\alpha$ and
        \item a right $(a_2,\max\{a_2 - f_2 \min\{\frac{a_1}{f_1}, \frac{a_2}{f_2}\}\})$-hat with a left-angle of $\beta$.
    \end{itemize}
\end{lemma}
...
\begin{proof}
    ...
    and \Cref{th:split-tangle}, it follows directly that the hat is a $\C(a,b)$-shape.
\end{proof}
